...
**libGDX非公式日本語wikiへようこそ！ここではlibGDXのAPIや機能に関する包括的なドキュメントを提供しています。**このWikiはコミュニティ主導で運営されており、誰でも編集可能です。情報が古いと感じた場合やより詳細な説明を追加したい場合には、[Wikiスタイルガイド](/wiki/misc/wiki-style-guide)を確認した上で、必要な修正を追加してください。
